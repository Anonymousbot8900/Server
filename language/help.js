...
Saya ${botname}, Bot ini menggunakan system Multi-Device Beta
Jika ada Bug / Error mohon dimaklumi karena bot ini masih tahap uji coba`
}

//—————「 List 」—————//
exports.list = (pushname) => {
	return`Halo kak ${pushname}, Silahkan dipilih list menunya yaww ..`
}
...
return`  _Selamat ${salam} kak ${pushname}_
  ...
  *≻* ${prefix}setallmenu
  ...
  RyBot-MultiDevice System
  Version : 0.2.21
  
  Bot masih dalam tahap pembuatan!, Start pembuatan 03-July-2022
  `
}
...
exports.thanksto = () => {
	return`
   _Fitur Masih dalam tahap pengembangan!_
`
}